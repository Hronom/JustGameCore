...
namespace JGC
{
    ...
    bool InputSystem::isKeyDown(const OIS::KeyCode &xKey)
    {
        return mKeyboard->isKeyDown(xKey);
    }

    bool InputSystem::isKeyDown(const OIS::MouseButtonID &xKey)
    {
        return mMouse->getMouseState().buttonDown(xKey);
    }

    OIS::MouseState InputSystem::getMouseState()
    {
